    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href=<?=\yii\helpers\Url::to(['index/goods','id'=>$v->id])?>><img src="<?=$v->logo; ?>" alt="" /></a></dt>
        ...
        <!-- 分页信息 start -->
        <?php $this->registerJsFile('@web/datatable/media/js/jquery.dataTables.js'); ?>
