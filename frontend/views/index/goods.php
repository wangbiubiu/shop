		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
                    <?php foreach($model->photo as $k=>$v): ?>
                        <?php if($k==0){ ?>
					<div class="midpic">
						<a href=<?=$v->path ;?> class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img width="340px" src=<?=$v->path ;?> alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach($model->photo as $k=>$v): ?>
                                    <?php if($k==0){
                                        echo "<li class=\"cur\">"."<a class=\"zoomThumbActive\"";
                                    }else{
                                        echo"<li>"."<a";
                                    } ?>
									 href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$v->path;?>',largeimage: '<?=$v->path;?>'}"><img src=<?=$v->path;?>></a>
								</li>
                                <?php endforeach;?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?=$model->create_time ;?></li>
