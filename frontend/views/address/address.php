...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt><?=$data->name." ".$data->cmbProvince." ".$data->cmbCity." ".$data->cmbArea." ".$data->address." ".$data->tel ?></dt>
                <dd>
                    <a href=<?= \yii\helpers\Url::to(['address/edit','id'=>$data->id])?>>修改</a>
                    <a onclick="delmenu(<?=$data->id?>,this)" href="javascript:void(0)">删除</a>
            ...
            <form action="" name="address_form" method="post">
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" name="name" value="<?= isset($model->name)?$model->name:""
                        ?>" class="txt" />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="address" value="<?= isset($model->address)?$model->address:""
                        ?>" class="txt address"  />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="tel" class="txt" value="<?= isset($model->tel)?$model->tel:""
                        ?>" />
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="status" <?php
                        $a=isset($model->status)?$model->status:"";
                        if($a==1){
                            echo 'checked';
                        }
                        ?> value="1" class="check" />设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
<script type="text/javascript">
    addressInit('cmbProvince', 'cmbCity', 'cmbArea',"<?= isset($model->cmbProvince)?$model->cmbProvince:"";?>","<?= isset($model->cmbCity)?$model->cmbCity:"";?>","<?= isset($model->cmbArea)?$model->cmbArea:"";?>");
</script>
<script type="text/javascript">
...
//返回true表示删除
    if (isdel === true){
//利用Ajax请求根据id删除数据
        $.getJSON("http://www.yiishop.com/address/delete","id="+id+"",function (data){
//判定数据库是否删除成功成功返回1
            if (data == 1){
//根据id获取对应的父节点并删除
                var tr=$(name).closest('dl');
console.log(tr);
                tr.remove();
            }
        })
