        ...
        <div class="order_bd mt10">
            <table class="orders">
                ...
                <?php foreach($models as $model): ?>
                    <?php if($model->order->member_id==\Yii::$app->user->id){ ?>
                <tr>
                    <td><a href=""><?= $model->id?></a></td>
                    <td><a href=""><img src="<?= $model->logo?>" alt="" /></a></td>
                    <td><?= $model->order->name?></td>
                    <td>￥<?= $model->price?><?= " ".$model->order->payment_name?></td>
                    <td><?= $model->order->create_time?></td>
                    <td><?php
                        $s=$model->order->status;
                        if($s==0){
                            echo '已取消';
                        }
                        if($s==1){
                        ...
                        ?></td>
                    <td><a href="">查看</a> | <a href="<?= \yii\helpers\Url::to(['order/del','id'=>$model->id])?>">删除</a></td>
                </tr>
                <?php } ?>
                <?php endforeach;?>
                </tbody>
