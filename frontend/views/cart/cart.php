...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data-id="<?=$model->id?>">
            ...
            <td class="col3">￥<span><?=$model->market_price?></span></td>
            <td class="col4">
            ...
            <td class="col5">￥
                <span ><?=$model->market_price*$carts[$model->id]?></span>
            </td>
            <td class="col6">
                <a class="del" href="javascript:void(0)" onclick="del(<?=$model->id?>,this)">删除</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </tbody>
...
//    $(".del").blur(function(){
//        var a= $(this).closest('td').prev().children().innerText();
//        console.dir(a);
//
//
////        $("#total").
////        changeAmount($(".amount").closest('tr').attr('data-id'),$(this).val());
//    });
</script>
</body>
</html>
